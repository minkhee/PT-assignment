/**
    Group Assignment : Snake and Ladders
    Group Members & ID :
    1. Caitlin Lee Shiao Juen   B04180020
    2. Lee Yee Von              B04180034
    3. Ho Ping                  B04180015
    4. Tang Min Khee            B04180044
    5. Abdul Azim Bin Azlan     B04180024
    Date: 23 July 2018 to 03 August 2018
**/
...
int main (){
    ...
    printf("            ||          /    |     WELCOME     |      |____|    ||    \n");
    printf("            ||         /     |   ~   TO   ~    |      |____|    ||    \n");
    printf("            ||  8____ /___   | SNAKE & LADDERS |      |____|    ||    \n");
    printf("            ||     <______>  -------------------      |____|    ||    \n");
    printf("            ||                                        |    |    ||    \n");
    printf("             ====================================================\n");
